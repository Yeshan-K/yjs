...
<dl>
  ...
  <dd>
Library with <code>YMultiDocUndoManager</code> (undo/redo across Yjs docs)
and <code>YKeyValue</code> (optimized key-value store).
  </dd>
  <dt>
    <a href="https://github.com/Tulip-Writer/yjs-orderedtree">yjs-orderedtree</a> 🌳
  </dt>
  <dd>
Class for ordered trees via Y.Map. Handles <code>insert</code>, <code>delete</code>, 
and <code>move</code> operations for folder-like hierarchies.
  </dd>
</dl>
